...
return(
  ...
  flex-1 xl:max-w-[500px] max-w-full flex flex-col ">
    <div className="w-full flex flex-col">
      <div className="flex flex-row justify-between items-center">
        <h2 className="text-white font-bold items-center">Top Charts</h2>
        <Link to="/top-charts">
          <p className="text-gray-300 test-base cursor-pointer">See More</p>
        </Link>
      ...
      <div className="flex flex-row justify-between items-center">
        <h2 className="text-white font-bold items-center">Top Artist</h2>
        <Link to="/top-artist">
          <p className="text-gray-300 test-base cursor-pointer">See More</p>
        </Link>
